		...
		<div class="row second-line">
			<div class="col-sm-3">
				...
				<p class="redes-sociais">
					<a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico-insta.png" /></a>
					<a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico-fb.png" /></a>
				</p>
			</div>
			<div class="col-sm-3">
				<h5>Informações</h5>
			...
			<div class="col-sm-3">
				...
				<div class="mail-form">
					<?php echo do_shortcode('[contact-form-7 id="169" title="Mailing"]'); ?>
				</div>
			</div>
		</div>
...
jQuery(document).ready(function($){
	...
	$('#site-header-cart').html('<li><a href="http://ecwd.net/revival/carrinho/">Carrinho</a></li>');
    ...
    verticalSwiping: true,
	  ...
	  $('.btn-prev').on('click', function(){
		...
		/* reorganiza as abas */
		$('#tab-description').appendTo('ul #tab-title-description');
